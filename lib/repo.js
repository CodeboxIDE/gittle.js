...
var Actor, Commit, Diff, Head, Ref, Repo, Status, Tag, Tree, cmd, _, _ref, Q;
...
module.exports = Repo = (function() {
    ...
    Repo.prototype.remote_fetch = function(name) {
        return this.git("fetch", {}, name);
    };

    Repo.prototype.remote_push = function(name) {
        return this.git("push", {}, name);
    };
    ...
    Repo.prototype.branch = function(name) {
        if (!name) {
            ...
            return this.branches().then(function(heads) {
                ...
                return Q.reject(new Error("No branch named '" + name + "' found"));
            });
        }
    };
    ...
    Repo.prototype.sync = function(remote_name, branch_name) {
        ...
        return this.status().then(function(stat) {
            ...
            return that.pull(remote, branch);
        }).then(function(out) {
            return that.push(remote, branch);
        }).then(function() {
    ...
    Repo.prototype.pull = function(remote, branch) {
        remote = remote || "origin";
        branch = branch || "master";
        return this.git("pull", {}, [remote, branch]);
    };

    Repo.prototype.push = function(remote, branch) {
        remote = remote || "origin";
        branch = branch || "master";
    ...
    Repo.prototype.commitWith = function(name, email, msg, files) {
        ...
        var stage = this.stage_files.bind(this, files);
        var commit = this.commit.bind(this, msg);
